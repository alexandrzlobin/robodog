...
if("TRUE" STREQUAL "TRUE")
  set(i2cpwm_board_SOURCE_PREFIX /home/zlo/robodog/src/ros-i2cpwmboard)
  set(i2cpwm_board_DEVEL_PREFIX /home/zlo/robodog/devel)
  ...
  set(i2cpwm_board_INSTALL_PREFIX /home/zlo/robodog/install)
...
if(NOT "/home/zlo/robodog/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'i2cpwm_board' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/zlo/robodog/src/ros-i2cpwmboard/${idir}'.  ${_report}")
    endif()
